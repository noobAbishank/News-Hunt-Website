    ...
    return (
      ...
      />
        <Switch>
          ...
          <Route exact path="/technology"><News setProgress={this.setProgress} a={this.apiKey} key="technology" pageSize={this.pageSize} country="in" category="technology"/></Route>
          piKey
        </Switch>
        </Router>
      </div>
